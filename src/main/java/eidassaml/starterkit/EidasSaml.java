...
public class EidasSaml {
	 ...
	 */
	public static synchronized void Init() throws XMLConfigurationException
	{
		if(!isInit)
		{
			...
			try {
				...
				throw new XMLConfigurationException("EidasSaml: Can not init Templateloader. SAML Message will not build correctly!",e);
			}
	 ...
	 */
	public static byte[] CreateRequest(String _issuer, String _destination, String _providerName, EidasSigner _signer, Map<EidasPersonAttributes, Boolean> _requestedAttributes) throws XMLConfigurationException, CertificateEncodingException, IOException, XMLParserException, UnmarshallingException, MarshallingException, SignatureException, TransformerFactoryConfigurationError, TransformerException{
		Init();
	...
	public static byte[] CreateRequest(String _issuer, String _destination, EidasSigner _signer, Map<EidasPersonAttributes, Boolean> _requestedAttributes, String _id) throws XMLConfigurationException, CertificateEncodingException, IOException, XMLParserException, UnmarshallingException, MarshallingException, SignatureException, TransformerFactoryConfigurationError, TransformerException{
		Init();
	 ...
	 * @throws TransformerException thrown if there is a problem to create the saml request
	 */
	public static byte[] CreateRequest(String _issuer, String _destination,String _providerName, EidasSigner _signer, Map<EidasPersonAttributes, Boolean> _requestedAttributes,EidasRequestSectorType _selectorType, EidasNameIdType _nameIdPolicy, EidasLoA _loa) throws XMLConfigurationException, CertificateEncodingException, IOException, XMLParserException, UnmarshallingException, MarshallingException, SignatureException, TransformerFactoryConfigurationError, TransformerException{
		Init();
	 ...
	 * @throws IOException 
	 */
	public static EidasRequest ParseRequest(InputStream is) throws XMLConfigurationException, XMLParserException, UnmarshallingException, ErrorCodeException, IOException{
		Init();
	 ...
	 * @throws IOException 
	 */
	public static EidasRequest ParseRequest(InputStream is, List<X509Certificate> authors) throws XMLConfigurationException, XMLParserException, UnmarshallingException, ErrorCodeException, IOException{
		Init();
	 ...
	 */
	public static EidasResponse ParseResponse(InputStream is,X509KeyPair[] decryptionKeyPairs, X509Certificate[] signatureAuthors) throws XMLConfigurationException, XMLParserException, UnmarshallingException, ErrorCodeException
	{
		Init();
	 ...
	 * @throws TransformerException
	 */
	public static byte[] CreateMetaDataService(String id, String entityId, Date validUntil, EidasLoA highestSupportedLoA, X509Certificate sigCert, X509Certificate encCert, EidasOrganisation organisation, EidasContactPerson technicalcontact, EidasContactPerson supportContact, String postEndpoint, String redirectEndpoint, List<EidasNameIdType> supportedNameIdTypes, List<EidasPersonAttributes> attributes, EidasSigner signer) throws XMLConfigurationException, CertificateEncodingException, IOException, XMLParserException, UnmarshallingException, MarshallingException, SignatureException, TransformerFactoryConfigurationError, TransformerException{
		Init();
	 ...
	 * @throws IOException
	 */
	public static EidasMetadataService ParseMetaDataService(InputStream is) throws XMLConfigurationException, CertificateException, XMLParserException, UnmarshallingException, IOException
	{
		Init();
	 ...
	 * @throws TransformerException
	 */
	public static byte[] CreateMetaDataNode(String id, String entityId, Date validUntil, X509Certificate sigCert, X509Certificate encCert, EidasOrganisation organisation, EidasContactPerson techcontact, EidasContactPerson supportcontact,String postEndpoint, EidasRequestSectorType _spType, List<EidasNameIdType> supportedNameIdTypes, EidasSigner signer) throws XMLConfigurationException, CertificateEncodingException, IOException, XMLParserException, UnmarshallingException, MarshallingException, SignatureException, TransformerFactoryConfigurationError, TransformerException
	{
		Init();
	 ...
	 * @throws DOMException 
	 */
	public static EidasMetadataNode ParseMetaDataNode(InputStream is) throws XMLConfigurationException, CertificateException, XMLParserException, UnmarshallingException, IOException, DOMException, ErrorCodeException
	{
		Init();
	 ...
	 * @throws ConfigurationException 
	 */
	public static void ValidateEidasRequest(EidasRequest request) throws XMLConfigurationException {
		//TODO: OpenSAML 3.x does not provide the ValidationSuite anymore. As it was not used in the SDK perhaps we should remove this?
//		Init();
